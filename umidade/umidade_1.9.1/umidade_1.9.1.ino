...
void loop() {
  ...
  int sendData[] = {pinoAnalog, Percentual, pinoRele, pinoAnalog, Percentual1, pinoRele1};
 ...
 /* if (analogRead(pinoAnalog) >= 850) {
    ...
    while (analogRead(pinoAnalog) >= 400) {
...
*/
  delay (30000); // Estabelece o tempo de 1s para reinicializar a leitura
