...
if ((analogRead(pinoAnalog) >= 850) && (analogRead(pinoAnalog1) >= 850))
{  


while ((analogRead(pinoAnalog) >= 500) or (analogRead(pinoAnalog1) >= 500))
{ 
...
else if (analogRead(pinoAnalog) >= 850) 
{  


while (analogRead(pinoAnalog) >= 500) { 
...
while (analogRead(pinoAnalog1) >= 500) { 
...
else if ((analogRead(pinoAnalog1) <= 850) && (analogRead(pinoAnalog1) <= 850)) {
