...
void PrintData( void )
{
    ...
    Serial.print( "Soil Humidity....: " ); Serial.print( (float)val/10.0, 1 ); Serial.println("%");

    //1 index 5     temperature
    val = (values[5] << 8) + values[6];
    Serial.print( "Soil Temperature.: " ); Serial.print( (float)val/10.0, 1 ); Serial.println("oC");
